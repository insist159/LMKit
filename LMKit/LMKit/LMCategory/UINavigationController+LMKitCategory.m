//
//  UINavigationController+LMKitCategory.m
//  AudioWork
//
...
#import "UINavigationController+LMKitCategory.h"

@implementation UINavigationController (LMKitCategory)
...
{
    return [self popToViewController:[self lm_findViewController:className] animated:YES];
}
/**
 *  @brief  pop n层
 *
